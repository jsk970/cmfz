...
CREATE TABLE province (
  ...
  provinceID varchar2(6) default NULL,
...
CREATE TABLE city (
  ...
  cityID varchar2(6) default NULL,
  city varchar2(50) default NULL,
  father varchar2(6) default NULL,
  PRIMARY KEY  (cid)  
);
--区
CREATE TABLE area (
  rid number(11) NOT NULL,
  areaID varchar2(50) default NULL,
  area varchar2(60) default NULL,
  father varchar2(6) default NULL,
  primary key(rid)
);
--省数据
